...
public class PostManTest {
    ...
    private model.Person aSecretPal;
    ...
    public void When_I_try_to_send_a_mail_with_a_valid_address_the_operation_is_successful() throws MessagingException, IOException {
        model.Person aReceiver = new PersonBuilder().withEmail("roman.rizzi@10pines.com").build();
    ...
    private String assignationTextFor(model.Person receiver) {
